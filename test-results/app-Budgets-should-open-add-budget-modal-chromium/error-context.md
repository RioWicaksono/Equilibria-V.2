...
- Name: app.spec.ts >> Budgets >> should open add budget modal
- Location: tests\e2e\app.spec.ts:101:7
...
Locator: getByRole('button', { name: /tambah budget/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /tambah budget/i })
