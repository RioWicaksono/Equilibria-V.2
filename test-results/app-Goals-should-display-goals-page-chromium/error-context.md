...
- Name: app.spec.ts >> Goals >> should display goals page
- Location: tests\e2e\app.spec.ts:113:7
...
Locator: getByRole('heading', { name: /target/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /target/i })
