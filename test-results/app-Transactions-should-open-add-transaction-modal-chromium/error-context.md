...
- Name: app.spec.ts >> Transactions >> should open add transaction modal
- Location: tests\e2e\app.spec.ts:45:7
...
Locator: getByRole('button', { name: /tambah transaksi/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /tambah transaksi/i })
