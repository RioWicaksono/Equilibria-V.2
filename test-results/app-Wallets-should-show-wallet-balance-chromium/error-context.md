...
- Name: app.spec.ts >> Wallets >> should show wallet balance
- Location: tests\e2e\app.spec.ts:135:7
...
Locator: getByText(/BCA/i).or(getByText(/Rp/i))
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/BCA/i).or(getByText(/Rp/i))
