...
- Name: app.spec.ts >> Wallets >> should display wallets page
- Location: tests\e2e\app.spec.ts:129:7
...
Locator: getByRole('heading', { name: /dompet/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /dompet/i })
