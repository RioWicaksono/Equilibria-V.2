...
- Name: app.spec.ts >> Budgets >> should display budgets page
- Location: tests\e2e\app.spec.ts:95:7
...
Locator: getByRole('heading', { name: /budget/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /budget/i })
