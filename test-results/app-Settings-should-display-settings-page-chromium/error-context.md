...
- Name: app.spec.ts >> Settings >> should display settings page
- Location: tests\e2e\app.spec.ts:144:7
...
Locator: getByRole('heading', { name: /pengaturan/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /pengaturan/i })
